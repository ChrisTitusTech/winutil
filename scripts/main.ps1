...
$sync["EnglishLanguageMenuItem"].Add_Click({
        Write-Debug "English language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "en-US"
    })
$sync["FrenchLanguageMenuItem"].Add_Click({
        Write-Debug "French language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "fr-FR"
    })
$sync["SpanishLanguageMenuItem"].Add_Click({
        Write-Debug "Spanish language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "es-ES"
    })
$sync["GermanLanguageMenuItem"].Add_Click({
        Write-Debug "German language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "de-DE"
    })
$sync["ItalianLanguageMenuItem"].Add_Click({
        Write-Debug "Italian language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "it-IT"
    })
$sync["PortugueseLanguageMenuItem"].Add_Click({
        Write-Debug "Portuguese language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
        Invoke-WinUtilLocalization -Language "pt-PT"
    })
$sync["PolishLanguageMenuItem"].Add_Click({
        Write-Debug "Polish language selected"
        Invoke-WPFPopup -Action "Hide" -Popups @("Language")
