...
$sync.configs.tweaks = '{
  ...
  "WPFEssTweaksRemoveEdge": {
    "InvokeScript": [
        "curl.exe -s \"https://raw.githubusercontent.com/ChaseKnowlden/winutil/remove-edge/removeedge.bat\" -o $ENV:temp\\removeedge.bat
        cmd.exe /c %temp%\\removeedge.bat
        "
    ]
  },
