...
\/    \/|_| \___||_|    \___/   \/  \/  |_||_| |_| 
                                    ...
                                    <TextBlock Margin="15,15,15,0" 
                                        ...
                                        - Download the latest Windows 11 image from Microsoft <LineBreak/>
                                            ...
                                            (may take several minutes to process the ISO depending on your machine) <LineBreak/>
                                        - Put it somewhere on the C:\ drive so it is easily accessible <LineBreak/>
                                        - Launch WinUtil and MicroWin  <LineBreak/>
                                        - Click on the Get Iso image button and wait for WinUtil to process the image <LineBreak/>
                                            It will be processed and unpacked which could take some time <LineBreak/>
                                        - Once done, choose which Windows flavor you want to base your image on <LineBreak/>
                                        ...
                                        <Bold>Once done, the microwin.iso will be in the %temp% directory</Bold> <LineBreak/>
                                        Copy this image to your Ventoy USB Stick, boot to this image, gg
                                        <LineBreak/>
                                        If you are injecting drivers make sure to put all your inf, sys, and dll files for each driver into a separate directory. For example:
                                    </TextBlock>
