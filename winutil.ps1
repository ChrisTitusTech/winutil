                ...
                <Grid Background="Transparent">
                    ...
                    <Border Grid.Row="0" Grid.Column="0">
                        <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
                            ...
                            <CheckBox Name="WPFFeaturesdotnet" Content="All .Net Frameworks (2,3,4)" Margin="5,0" ToolTip=".NET and .NET Framework is a developer platform made up of tools, programming languages, and libraries for building many different types of applications."/>
