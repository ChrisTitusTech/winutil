        ...
        <Setter Property="Template">
            <Setter.Value>
                <ControlTemplate TargetType="{x:Type ToggleButton}">
                    ...
                    <TextBlock Grid.Column="0" x:Name="txtToggle" VerticalAlignment="Center" FontWeight="DemiBold" Foreground="White" FontSize="12">
                    <TextBlock.Style>
                    ...
                    <ControlTemplate.Triggers>
                        <Trigger Property="IsMouseOver" Value="True">
                            ...
                            <Setter Property="Effect">
                                <Setter.Value>
                                    <DropShadowEffect Opacity="1" ShadowDepth="5" Color="Gold" Direction="-100" BlurRadius="25"/>
                                </Setter.Value>
                            </Setter>
                        ...
                        <Trigger Property="ToggleButton.IsChecked" Value="True">
                            ...
                            <Setter TargetName="Ellipse" Property="Fill" Value="{LinkHoverForegroundColor}" />
                            <Setter TargetName="Border" Property="BorderBrush" Value="{LinkHoverForegroundColor}" />
                            <Trigger.EnterActions>
                                <BeginStoryboard>
                                    <Storyboard>
                                        <ColorAnimation Storyboard.TargetName="Border"
                                                Storyboard.TargetProperty="(Border.Background).(SolidColorBrush.Color)"
                                                To="{MainForegroundColor}" Duration="0:0:0.1" />
