...
<Button Name="WPFTab1BT_Buttons_WPFinstall" Content=" Install Selected" Margin="1"/>
<Button Name="WPFTab1BT_Buttons_WPFInstallUpgrade" Content=" Upgrade All" Margin="1"/>
<Button Name="WPFTab1BT_Buttons_WPFuninstall" Content=" Uninstall Selection" Margin="1"/>
<Button Name="WPFTab1BT_Buttons_WPFGetInstalled" Content=" Get Installed" Margin="1"/>
<Button Name="WPFTab1BT_Buttons_WPFclearWinget" Content=" Clear Selection" Margin="1"/>
</StackPanel>
...
<Label Content="Recommended Selections:"  VerticalAlignment="Center"/>
<Button Name="WPFTab2BT_Buttons_WPFdesktop" Content=" Desktop " Margin="1"/>
<Button Name="WPFTab2BT_Buttons_WPFlaptop" Content=" Laptop " Margin="1"/>
<Button Name="WPFTab2BT_Buttons_WPFminimal" Content=" Minimal " Margin="1"/>
<Button Name="WPFTab2BT_Buttons_WPFclear" Content=" Clear " Margin="1"/>
<Button Name="WPFTab2BT_Buttons_WPFGetInstalledTweaks" Content=" Get Installed " Margin="1"/>
</StackPanel>
<ScrollViewer Grid.Row="1" Grid.Column="0" Padding="-1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Auto"
BorderBrush="Transparent" BorderThickness="0" HorizontalAlignment="Stretch" VerticalAlignment="Stretch">
<Grid HorizontalAlignment="Stretch" VerticalAlignment="Stretch">
...
<Button Name="WPFTweaksUndoall" Content="Undo Selected Tweaks" HorizontalAlignment = "Left" Width="160" Margin="5" Padding="20,5" />
</StackPanel>
</Border>
<Border Grid.Row="1" Grid.Column="1">
<StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
...
<Button Name="WPFTweaksAddUltPerf" Content="Add and Activate Ultimate Performance Profile" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
<Button Name="WPFTweaksRemoveUltPerf" Content="Remove Ultimate Performance Profile" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
<Label Content="Shortcuts" FontSize="16"/>
<Button Name="WPFTweaksWinUtilShortcut" Content="Create WinUtil Shortcut" HorizontalAlignment = "Left" Width="300" Margin="5" Padding="20,5" />
</StackPanel>
</Border>
</Grid>
</ScrollViewer>
...
<Border Grid.Row="1" Grid.Column="2">
<StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
<Button Name="WPFUpdatesdisable" FontSize="16" Content="Disable ALL Updates (NOT RECOMMENDED!)" Margin="20,4,20,10" Padding="10"/>
