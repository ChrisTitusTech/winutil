...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallexplorerpatcher" Content="Explorer Patcher" ToolTip="This project aims to enhance the working environment on Windows." Margin="0,0,2,0"/><TextBlock Name="WPFInstallexplorerpatcherLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://github.com/valinet/ExplorerPatcher" />
</StackPanel>
<StackPanel Orientation="Horizontal">
