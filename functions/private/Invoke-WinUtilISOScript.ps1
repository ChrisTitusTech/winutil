function Invoke-WinUtilISOScript {
    ...
    # â”€â”€ 1. Remove provisioned AppX packages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 2. Inject current system drivers (optional) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        try {
            ...
            if ($ISOContentsDir -and (Test-Path $ISOContentsDir)) {
                ...
                if (Test-Path $bootWim) {
                    ...
                    & $Log "Warning: boot.wim not found â€” skipping boot.wim driver injection."
                }
            }
        } catch {
    ...
    # â”€â”€ 3. Registry tweaks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    if ($AutoUnattendXml) {
        try {
            ...
            if ($fileNodes -and $fileNodes.Count -gt 0) {
                ...
                & $Log "Warning: no <Extensions><File> nodes found in autounattend.xml â€” setup scripts not pre-staged."
            }
        } catch {
        ...
        & $Log "Warning: autounattend.xml content is empty â€” skipping OOBE bypass file."
    }
    ...
    # â”€â”€ 4. Delete scheduled task definition files â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 5. Remove ISO support folder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if ($ISOContentsDir -and (Test-Path $ISOContentsDir)) {
