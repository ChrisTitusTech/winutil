...
- **Restarts**: Scheduled updates will be downloaded automatically, but there will be a notification before installation to give users control over when the updates are applied.
