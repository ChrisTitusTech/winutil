...
* Click the highlighted category again, or click `All`, to clear the filter.
* A collapsed category opens while a filter is on, and goes back to collapsed once you clear it.
</TabItem>
