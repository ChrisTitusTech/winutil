...
3. **Never touch anything under `docs/src/content/docs/code-reference/`.** It is auto-generated by `tools/devdocs-generator.ps1` via the `docs.yaml` GitHub Actions workflow. Edit the source JSON (`config/tweaks.json`, `config/feature.json`) or the relevant PowerShell function file instead.
