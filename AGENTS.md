...
- When hosted review is unavailable and local reviewers are requested, have independent local reviewers exchange findings and recheck the final fixes; do not treat an unanswered hosted request as a completed review.
